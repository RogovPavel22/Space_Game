...
import { ArtObject } from "./ui/ArtObject";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className={clsx(styles.section, styles.section_logos)}>
      ...
      <section className={clsx(styles.section, styles.sectionDifficultForms)}>

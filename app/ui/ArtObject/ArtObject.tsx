...
export const ArtObject: React.FC<ArtObjectProps> = ({ className }) => {
  return (
    <div className={clsx(styles.artObject, className)}>
      <div className={styles.artObjectContainer}>
        <div className={styles.artObjectColumn}>
          <div className={clsx(styles.artObjectRow, styles.artObjectTextSpace)}>
            <h3>How many?</h3>
            <p>
              Our genesis land NFT collection will comprise <br />
              <strong className={styles.artObjectLarge}>5555 NFTs</strong>.
            </p>
          </div>
          <div className={clsx(styles.artObjectRow, styles.artObjectTrio)}>
            <div>
          ...
          <div className={clsx(styles.artObjectRow, styles.artObjectTextSpace)}>
            <h3>How much?</h3>
            <p>
              Each genesis land NFT will be priced at <br />
        ...
        <div className={styles.artObjectColumn}>
          ...
          <div className={clsx(styles.artObjectRow, styles.artObjectTwo)}>
            <div>
